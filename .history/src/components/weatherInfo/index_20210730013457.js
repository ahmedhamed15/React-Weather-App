        ...
        <div className="info-side">
            ...
            <div className="week-container">
                <ul className="week-list">
                    <li className="active"><span className="day-name">TEMP</span><span className="day-temp">{props.temp} °C</span></li>
                    <li><span className="day-name">MAX</span><span className="day-temp">{props.temp_max}°C</span></li>
                    <li><span className="day-name">MIN</span><span className="day-temp">{props.temp_min}°C</span></li>
                    <div className="clear"></div>
                </ul>
            </div>
