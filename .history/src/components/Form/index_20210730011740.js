                ...
                <form onSubmit={this.submitHandle}>
                    <div className="form-group countries-group">
                        ...
                        <select name="country" onChange={this.changeCity}>
                            ...
                            { this.props.data.map( (el, ix) => <option key={ix} value={el.country}> {el.country} </option> ) }
                        </select>
                    </div>
                    { this.props.IsCountrySelected && (
                        <div className="form-group cities-group">
                            ...
                            <select name="city" onChange={this.checkCityIsSelected}>
                                ...
                                { this.props.cities.map( (el, ix) => <option key={ix} value={el}> {el} </option> ) }
                            </select>
                        </div>
                    ) }
                    { this.props.IsCitySelected && this.props.IsCitySelected && (
